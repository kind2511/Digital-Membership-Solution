...
class CreateActivityTestCase(APITestCase):
    def test_create_activity_invalid_data(self):
        ...
        invalid_data = {'title': '', 'description': 'Description of the new activity'}
        ...
        # Check that the response contains errors
        self.assertIn('title', response.data)  # Assuming 'title' is a required field
